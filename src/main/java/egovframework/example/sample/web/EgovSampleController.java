...
public class EgovSampleController {
	...
	public String busan() {
		System.out.println("/busan.do");
		return "sample/board_busan.html";
	}
	@RequestMapping(value = "/daegu.do")
	public String daegu() {
		System.out.println("/daegu.do");
		return "sample/board_daegu.html";
	}
	@RequestMapping(value = "/daejeon.do")
	public String daejeon() {
		System.out.println("/daejeon.do");
		return "sample/board_daejeon.html";
	}
	@RequestMapping(value = "/incheon.do")
	public String incheon() {
		System.out.println("/incheon.do");
		return "sample/board_incheon.html";
	}
	@RequestMapping(value = "/seoul.do")
	public String seoul() {
		System.out.println("/seoul.do");
		return "sample/board_seoul.html";
	}
	@RequestMapping(value = "/ulsan.do")
	public String ulsan() {
		System.out.println("/ulsan.do");
		return "sample/board_ulsan.html";
	}
	...
	public String callback() {
		...
		return "sample/callback.html";
	}
	@RequestMapping(value = "/about.do")
	public String about() {
		System.out.println("/about.do");
		return "sample/about.html";
	}
